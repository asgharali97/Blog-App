    ...
    <>
      <header className="px-10 py-5 flex items-center justify-between relative">
        ...
        <nav className="flex items-center text-black border border-black py-3 px-8  w-max  border-solid rounded-full font-medium capitalize fixed top-2 right-1/2 translate-x-1/2 bg-white/80 backdrop-blur-sm z-50 dark:bg-[#d1d1d1]">
          <ul className="flex items-center">
            ...
            <button
              ...
              className="w-6 h-6 ease ml-2 flex items-center justify-center rounded-full p-1 bg-black text-white dark:bg-white text-light dark:text-black"
            >
              {themeMode === "light" ? (
                <svg
        ...
        <div className="flex items-center">
          <Link
            target="_blank"
            to="https://www.linkedin.com/in/asghar-alifs48"
          ...
          >
            <svg
              ...
              height="43"
              viewBox="0 0 42 43"
              className="w-6 h-auto hover:scale-125 transition-all ease duration-200 fill-white"
            >
              <g clip-path="url(#a)">
                <path
                  fill="#0076B2"
          ...
          <Link
            target="_blank"
            to="https://x.com/Asgharali122881"
            className="h-6 w-6 mr-4 inline-block"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <Link
            target="_blank"
            to="https://github.com/asgharali97"
            className="h-6 w-6 mr-4 inline-block"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              ...
              height="44"
              viewBox="0 0 42 44"
              className="w-6 h-auto hover:scale-125 transition-all ease duration-200 fill-black dark:fill-white "
            >
              <path
                fill-rule="evenodd"
