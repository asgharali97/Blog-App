...
const Header = () => {
  ...
  const socialLinks = [
    {
        name: 'LinkedIn',
        slug: "https://www.linkedin.com/in/asghar-alifs48/",
        svg: ''
    }
  ]
